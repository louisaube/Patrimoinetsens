...
export const seedContributions = [
  ...
  // --- Famille Salleron-Cornisset (avec lien Corot) ---
  {
    ...
    authorId: DENIS,
    contributionType: 'historique' as const,
    title: "La belle-famille sénonaise de Corot",
    body: "Le père du peintre Corot a épousé une Sénonaise. Jean César Corot (1752-1820) se marie avec Colombe Cornisset, fille d'Edme Cornisset (1737-1793), un bourgeois bien établi à Sens. Leur fils Edme César Corot (1790-1850) naît et meurt à Sens. Le grand Camille Corot — l'un des plus célèbres paysagistes français, précurseur de l'impressionnisme — a donc des racines familiales directes dans cette ville. En 1874, un an avant sa mort, il peint deux vues de l'intérieur de la cathédrale de Sens, aujourd'hui au Louvre (RF 2225, salle 952). Ce n'est pas un hasard : il peint la cathédrale de sa famille.\n\nLes Cornisset sont une famille bourgeoise sénonaise documentée depuis le XVIIIe siècle. Par Colombe Virginie Cornisset (1770-1838), ils se connectent aux Luyt. Par Louise Cornisset (1799-1885), ils s'allient aux Salleron — Jean François Salleron (1795-1869), puis Ernest (1821-1891), puis Berthe (1863-1944). Par Marie Hélène Ursule Cornisset (1767-1844), ils rejoignent les Delions.\n\nUn réseau bourgeois qui irrigue la vie économique sénonaise pendant deux siècles — et qui, par un mariage, touche à l'histoire de l'art français.",
    sources: [
      'Archives départementales de l\'Yonne, registres paroissiaux et d\'état civil.',
      'Porée, Charles. "Histoire des rues et des maisons de Sens." 1920.',
    ],
